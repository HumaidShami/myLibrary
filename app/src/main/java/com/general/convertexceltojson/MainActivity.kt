package com.general.convertexceltojson
...
import com.general.h.dev.employees.util.E_Permission.checkPermission_me
import com.general.h.dev.employees.util.E_Permission.requestPermission
...
//        readExcelFileFromAssets()
    ...
    fun readExcelFileFromAssets(path:String)
    {
        try {
            ...
            val file = File(Environment.getExternalStorageDirectory().toString() + "/Book1.xls"
            )
            Log.e("Third",data)
            if (file.exists())
            {
